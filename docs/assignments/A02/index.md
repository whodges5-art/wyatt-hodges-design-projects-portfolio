...
## Decide
I decided to create my truss by connecting the four points to create a trapezoid I then connected points B and D because B is a roller and has one less reaction force. Designing it this way makes the analysis of the truss easiest because starting from joint C there will never be more than 2 unknown forces. 
